...
Website portofolio pribadi yang dirancang untuk menampilkan perjalanan saya sebagai **Frontend Developer** dan **Network Engineer**. Proyek ini dibangun dengan fokus pada desain antarmuka yang modern (Dark Mode), responsif, dan performa tinggi.
...
- 🌱 I'm currently learning **Python, Javascript, TailwindCSS, MikroTik RouterOS & Cisco**
- 🎓 **Education:** Information System Student
- ⚡ **Fun fact:** I can configure a router while styling a div!
...
- **Dark Mode UI:** Menggunakan skema warna `#121212` dengan aksen Emas (`#d4af37`) untuk kesan elegan.
- **SEO Optimized:** Dilengkapi dengan Meta Tags, Schema.org JSON-LD, dan Sitemap.
- **Blog/Knowledge Hub:** Kumpulan artikel teknis seputar Networking, SysAdmin, dan Programming dengan sistem filtering kategori.
- **Interactive Elements:**
  - Animasi Scroll Reveal.
  - Typing Effect pada Hero Section.
  - Download CV dengan Toast Notification.
  - Certificate Lightbox (Popup) untuk melihat detail sertifikat tanpa pindah halaman.
  - Preloader Animation untuk loading state yang smooth.
  - Dynamic Category Filtering di halaman blog.

---

## 🛠️ Tech Stack

Proyek ini dibangun menggunakan teknologi web standar tanpa framework berat, untuk menjaga performa tetap ringan dan cepat.

| Category       | Technology                                                                        |
| :------------- | :-------------------------------------------------------------------------------- |
| **Frontend**   | HTML5, CSS3 (Flexbox & Grid), JavaScript (ES6+)                                   |
| **Styling**    | Custom CSS Variables, Google Fonts (Poppins, Inter, Fira Code, Plus Jakarta Sans) |
| **Icons**      | SVG Icons, Boxicons                                                               |
...
├── Blog/                   # Knowledge Hub - Technical Blog
│   ├── Assets/             # Blog-specific assets
│   │   ├── Programming/    # Programming article images
│   │   ├── Networking/     # Networking article images
│   │   └── SysAdmin/       # SysAdmin article images
│   ├── Programming/        # Programming articles
│   │   └── ATM - Java/     # Java ATM tutorial with article.html
│   ├── Networking/         # Networking articles (coming soon)
│   ├── SysAdmin/           # SysAdmin articles (coming soon)
│   ├── index.html          # Blog homepage with filtering
│   ├── style.css           # Blog styling
│   └── script.js           # Category filtering & interactions
├── index.html              # Main portfolio page
├── style.css               # Main styling
├── script.js               # Main interactions (Modal, Navbar, Scroll)
...
Berikut adalah beberapa proyek yang ditampilkan di portfolio:
...
Website portfolio ini sendiri - menampilkan proyek, sertifikat, dan blog teknis.
...
- Text editor (VS Code, Sublime Text, dll) untuk development
...
© 2025 Badil Arrohman. All rights reserved.
...
- Netlify untuk hosting gratis dan cepat
